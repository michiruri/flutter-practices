...
class EstablishmentRegisterScreen extends StatefulWidget {
  const EstablishmentRegisterScreen({super.key});

  @override
  State<EstablishmentRegisterScreen> createState() =>
      _EstablishmentRegisterScreenState();
}

class _EstablishmentRegisterScreenState
    extends State<EstablishmentRegisterScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Register as Establishment')),
      body: Padding(
          ...
          child: ListView(
            children: [
              ...
              TextFormField(
                ...
                decoration: textFormDecoration('Business Name'),
                validator: (value) {
                  if (value == null || value.isEmpty) {
                    return '*Required';
                  }
